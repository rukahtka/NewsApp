...
public class CategoryNews extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(id.equalsIgnoreCase("customizedContainer"))
            fragID = R.id.customizedContainer;
        else
            fragID = R.id.categoryContainer;
        ...
        recyclerViewAdapter.setOnNewsArticleClickListener(new RecyclerViewAdapter.OnNewsArticleClickListener() {
            ...
            public void onNewsArticleClick(View v, int position) {
                ...
                getFragmentManager().beginTransaction().add(fragID,browser).addToBackStack(null).commit();
            }
        });
